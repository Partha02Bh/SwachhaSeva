...
// const geminiApiKey = "AIzaSyD5YpKJJbzFVOQ9XGslq97GQXOUpZC8s14";
...
export default function ReportPage() {
  ...
  const { isLoaded } = useJsApiLoader({
    ...
    googleMapsApiKey: "AIzaSyD5YpKJJbzFVOQ9XGslq97GQXOUpZC8s14",
    libraries: libraries
  });
  ...
  const handleVerify = async () => {
    ...
    try {
      const genAI = new GoogleGenerativeAI("AIzaSyDukjWsFS9RBEI9eI7u4gx9rjzth5tdFrI");
      ...
      // Step 3: Parse JSON and validate structure
      try {
        ...
        console.error('Failed to parse JSON response:', jsonResponse, parseError);
        setVerificationStatus('failure');
      }
    } catch (error) {
