...
// const clientId =
//   "BK4nKahgSqwh7t8nfARbl3NQmxxKOXss7yA6-1ZV4CTt-WUoeGcsg_SFXPTPp59bvOPYDGUGa8O2GfncHci9Fqs";
    ...
    <header className="bg-gray-100 border-b border-gray-200 sticky top-0 z-50">
      <div className="flex items-center justify-between px-4 py-2">
        <div className="flex items-center">
          <Button variant="ghost" size="icon" className="mr-2 md:mr-4 bg-gray-200" onClick={onMenuClick}>
            <Menu className="h-6 w-6 text-black" />
          </Button>
          <Link href="/" className="flex items-center">
            <Leaf className="h-6 w-6 md:h-8 md:w-8 text-green-500 mr-1 md:mr-2" />
            <div className="flex flex-col">
              <span className="font-bold text-base md:text-lg text-gray-800">SwachhSeva</span>
        ...
        <div className="flex items-center">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" size="icon" className="mr-2 bg-gray-100 relative">
